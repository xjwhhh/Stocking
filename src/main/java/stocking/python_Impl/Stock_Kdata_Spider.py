...
for i in range(0, len(list_of_all_the_lines)):
    ...
    j = j[0:6]
    newdf = ts.get_h_data(j, start=startDate, end=endDate)
    newdf2 = ts.get_h_data(j, start=startDate, end=endDate, autype=None)
    if (str(newdf) != 'None'):
        newdf3 = newdf.iloc[:, 0:4];
        newdf3.rename(columns={'close': "adjclose", 'open': 'adjopen', 'high': 'adjhigh', 'low': 'adjlow'},
                      inplace=True)
        d = newdf2.join(newdf3)
        d['code'] = j
        d.to_sql('kdata_szb', engine, if_exists='append')
        print(j)
print('深市B股成功')
...
for i in range(0, len(list_of_all_the_lines)):
    ...
    if (str(newdf) != 'None'):
        ...
        d = newdf2.join(newdf3)
        d['code'] = j
        d.to_sql('kdata_shb', engine, if_exists='append')
        print(j)
print('沪市B股成功')
...
for i in range(0, len(list_of_all_the_lines)):
    ...
    newdate = startDate
    newdf = ts.get_h_data(j, start=newdate, end=endDate)
    newdf2 = ts.get_h_data(j, start=newdate, end=endDate, autype=None)
    if (str(newdf) != 'None'):
        newdf3 = newdf.iloc[:, 0:4];
        newdf3.rename(columns={'close': "adjclose", 'open': 'adjopen', 'high': 'adjhigh', 'low': 'adjlow'},
                      inplace=True)
        d = newdf2.join(newdf3)
        d['code'] = j
        d.to_sql('kdata_sha0', engine, if_exists='append')
        print(j)
print('沪市A股0成功')
...
for i in range(0, len(list_of_all_the_lines)):
    ...
    if (str(newdf) != 'None'):
        ...
        d = newdf2.join(newdf3)
        d['code'] = j
        d.to_sql('kdata_sha1', engine, if_exists='append')
        print(j)
print('沪市A股1成功')
...
for i in range(0, len(list_of_all_the_lines)):
    ...
    if (str(newdf) != 'None'):
        ...
        d = newdf2.join(newdf3)
        d['code'] = j
        d.to_sql('kdata_sha3', engine, if_exists='append')
        print(j)
print('沪市A股3成功')
#
...
for i in range(0, len(list_of_all_the_lines)):
    ...
    if (str(newdf) != 'None'):
        ...
        d = newdf2.join(newdf3)
        d['code'] = j
        d.to_sql('kdata_sza', engine, if_exists='append')
        print(j)
print('深市A股成功')
...
for i in range(0, len(list_of_all_the_lines)):
    ...
    if (str(newdf) != 'None'):
        ...
        d = newdf2.join(newdf3)
        d['code'] = j
        d.to_sql('kdata_cyb', engine, if_exists='append')
        print(j)
print('创业板成功')
...
for i in range(0, len(list_of_all_the_lines)):
    ...
    if (str(newdf) != 'None'):
        ...
        d = newdf2.join(newdf3)
        d['code'] = j
        d.to_sql('kdata_zxb', engine, if_exists='append')
        print(j)
print('中小板成功')
