...
public class Strategy_Data_ImplTest {
    ...
    public void traceBack3() throws Exception {
        ...
        JSONObject json = JSONObject.fromObject(strategyPO);//将java对象转换为json对象
        String str = json.toString();//将json对象转换为字符串
        String needStr="{\"alpha\":-3.40620087582,\"annualReturn\":-0.543536505762,\"basicAnnualReturn\":0.00233187723155,\"basicProfits\":[0.0199538597021,-0.0446985271936,0.025304318027],\"beta\":-0.909857363821,\"dates\":[\"2016-04-12\",\"2016-05-11\",\"2016-06-01\"],\"maxDrawDown\":0.0740759465827,\"profits\":[-0.0492113564669,-0.00358072916667,-0.0776566757493],\"sets\":[{\"codes\":[\"600518\",\"600999\"],\"names\":[\"康美药业\",\"招商证券\"],\"profits\":[-0.0492113564669,0.0915982312066]},{\"codes\":[\"600547\",\"600100\"],\"names\":[\"山东黄金\",\"同方股份\"],\"profits\":[-0.00358072916667,0.0783269961977]},{\"codes\":[\"600029\",\"600100\"],\"names\":[\"南方航空\",\"同方股份\"],\"profits\":[-0.0776566757493,0.0214621059691]}],\"sharpeRatio\":-29.0566418972}";
        assertEquals(needStr,str);
    }
    ...
    public void traceBack4() throws Exception {
        ...
        JSONObject json = JSONObject.fromObject(strategyPO);//将java对象转换为json对象
        String str = json.toString();//将json对象转换为字符串
        String needStr="{\"alpha\":-1.29884006506,\"annualReturn\":0.612644544747,\"basicAnnualReturn\":0.00233187723155,\"basicProfits\":[0.0199538597021,-0.0446985271936,0.025304318027],\"beta\":-0.274750195691,\"dates\":[\"2016-04-12\",\"2016-05-11\",\"2016-06-01\"],\"maxDrawDown\":0.0298172964655,\"profits\":[0.0560743546824,0.0603888162611,0.0305715197957],\"sets\":[{\"codes\":[\"600519\",\"601198\",\"600606\",\"600340\",\"600999\",\"600547\",\"601318\",\"600518\"],\"names\":[\"贵州茅台\",\"东兴证券\",\"绿地控股\",\"华夏幸福\",\"招商证券\",\"山东黄金\",\"中国平安\",\"康美药业\"],\"profits\":[0.0560743546824,0.234585741811,-0.0591204037491,0.050518134715,0.0915982312066,0.163657318479,0.00616083009079,-0.0492113564669]},{\"codes\":[\"600519\",\"600547\",\"600958\",\"601088\",\"600100\",\"601628\",\"600340\",\"601336\"],\"names\":[\"贵州茅台\",\"山东黄金\",\"东方证券\",\"中国神华\",\"同方股份\",\"中国人寿\",\"华夏幸福\",\"新华保险\"],\"profits\":[0.0603888162611,-0.00358072916667,-0.133577789419,-0.113170086036,0.0783269961977,-0.123966942149,-0.011939069576,-0.0408214375157]},{\"codes\":[\"600519\",\"601198\",\"601688\",\"601788\",\"600111\",\"601601\",\"600999\",\"600100\"],\"names\":[\"贵州茅台\",\"东兴证券\",\"华泰证券\",\"光大证券\",\"北方稀土\",\"中国太保\",\"招商证券\",\"同方股份\"],\"profits\":[0.0305715197957,0.0746472462449,0.13686249193,0.0713367609254,0.184566428003,0.016796875,0.0472751149048,0.0214621059691]}],\"sharpeRatio\":-28.5926209309}";
        assertEquals(needStr,str);
    }
